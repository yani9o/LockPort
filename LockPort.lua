...
function LockPort_Random_Summoning_Message(name)

	local summonMessages = {
		"Opening a dark portal to drag " .. name .. " out of the tavern.",
		"Sacrificing three gnomes and a goat... Summoning " .. name .. ".",
		"Summoning " .. name .. ". Please keep hands and feet inside the void during transit.",
		"Summoning " .. name .. ". WARNING: Side effects may include dizziness, nausea, and soul corruption.",
		"Summoning " .. name .. " from the Twisting Nether… or possibly the bathroom.",
		"Summoning " .. name .. ". Costs one shard, two assistants, and a small piece of my sanity.",
		"Summoning " .. name .. "—because walking is for mages.",
		"By fire, shadow, and questionable life choices… Summoning " .. name .. "!",
		"Summoning " .. name .. ". Don’t worry, we *mostly* fixed the soul explosion issue.",
		"Dragging " .. name .. " through the Nether like a sack of potatoes.",
		"Tearing reality apart to fetch " .. name .. "… again.",
		"Summoning " .. name .. ". If you hear screaming, that’s normal.",
		"Conjuring " .. name .. " from the void. Return policy: none.",
		"Summoning " .. name .. ", please remain seated until the portal comes to a complete stop.",
		"Fishing " .. name .. " out of the Nether—hope they don’t smell too fel-burnt.",
		"Summoning " .. name .. ", because walking is hard.",
		"Summoning " .. name .. ". Last time they came out inside-out, but it’ll be fine.",
		"Calling forth " .. name .. ". Please keep your limbs inside the summoning circle.",
		"Summoning " .. name .. ". WARNING: May arrive upside down.",
		"Summoning " .. name .. ". Summoning you straight into disappointment since 2004.",
		"Summoning " .. name .. "—don’t blame me if you lose a shoe on the way.",
		"Yanking " .. name .. " through the Twisting Nether like a bad fishing catch.",
		"Summoning " .. name .. ". Fel Airlines appreciates your soul shards."
	}

	return summonMessages[math.random(1, table.getn(summonMessages))]
		...
		if LockPort_UnitIDDB then
			...
			if UnitID then
				...
				if not playercombat and not targetcombat then
    				...
    				base_message 			= LockPort_Random_Summoning_Message(name)
    				base_whisper_message 	= LockPort_Random_Summoning_Message("you")
